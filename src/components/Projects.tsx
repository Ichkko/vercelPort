...
/* ── Regular editorial card (no fold animation) ── */
...
function ProjectCard({ project, idx, t }: ProjectCardProps) {
  return (
    <motion.article
      className="group relative flex flex-col overflow-hidden rounded-xl border border-[var(--line)] bg-[var(--bg-elevated)]"
...
export function Projects() {
  ...
  return (
    <section id="projects" className="scroll-mt-8">
      ...
      {/* ── Rest — regular editorial card grid ── */}
