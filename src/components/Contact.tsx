...
export function Contact() {
  ...
  return (
    <section id="contact" className="scroll-mt-8 lg:ml-[0px]">
      <div className="relative overflow-hidden bg-[#1b2540] px-4 py-8 text-white sm:px-6 sm:py-10 md:px-10 md:py-12 lg:px-14 dark:bg-[#071012] dark:shadow-[inset_0_1px_0_rgba(214,245,237,0.08)]">
        <div className="relative mx-auto grid max-w-[1040px] gap-8 lg:grid-cols-[1.2fr_0.8fr] lg:items-start">
          ...
          <SlideIn direction="left">
            ...
            <form onSubmit={handleSubmit} className="mt-6 space-y-4">
              ...
              <motion.button
                ...
                whileHover={{ y: -2 }}
                whileTap={{ scale: 0.97 }}
                className="inline-flex w-full items-center justify-center gap-2 rounded-full bg-[var(--teal)] px-7 py-3 text-sm font-bold text-white shadow-lg shadow-teal-500/25 transition disabled:opacity-60 sm:w-auto"
              >
                {status === "loading" ? (
                  <>
